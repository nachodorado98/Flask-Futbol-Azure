...
with DAG("dag_competiciones",
	...
	tarea_data_lake_disponible=BranchPythonOperator(task_id="data_lake_disponible", python_callable=lambda: data_lake_disponible_creado("subir_data_lake.subir_competiciones_data_lake"))
...
tarea_ejecutar_dag_competiciones >> tareas_entorno >> tareas_pipelines_competiciones >> tarea_data_lake_disponible >> [tareas_subir_data_lake, tarea_log_data_lake]

tareas_subir_data_lake >> tarea_dag_competiciones_completado