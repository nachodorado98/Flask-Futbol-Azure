...
with DAG("dag_partidos_jugadores_completo",
	...
	with TaskGroup("pipelines_partidos_jugadores_total") as tareas_pipelines_partidos_jugadores_total:

		tarea_pipeline_partidos_equipo_total=PythonOperator(task_id="pipeline_partidos_equipo_total", python_callable=Pipeline_Partidos_Equipo_Total, op_kwargs={"equipo": equipo_id}, trigger_rule="none_failed_min_one_success")

		tarea_pipeline_jugadores_equipo_total=PythonOperator(task_id="pipeline_jugadores_equipo_total", python_callable=Pipeline_Jugadores_Equipo_Total, op_kwargs={"equipo": equipo_id})

		tarea_pipeline_proximos_partidos_equipo_total=PythonOperator(task_id="pipeline_proximos_partidos_equipo_total", python_callable=Pipeline_Proximos_Partidos_Equipo, op_kwargs={"equipo_id": equipo_id, "equipo_id_real":equipo_id_real})


		tarea_pipeline_partidos_equipo_total >> tarea_pipeline_jugadores_equipo_total >> tarea_pipeline_proximos_partidos_equipo_total


tareas_entorno >> tareas_pipelines_partidos_jugadores_total 