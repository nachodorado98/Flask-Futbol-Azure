...
from pipelines import Pipeline_Jugadores_Faltantes, Pipeline_Jugadores_Equipos_Faltantes, Pipeline_Jugadores_Seleccion_Faltantes
...
with DAG("dag_jugadores_faltantes",
		start_date=days_ago(1),
		description="DAG para obtener datos de los jugadores faltantes de la web de futbol que tienen datos vacios",
	...
	with TaskGroup("pipelines_jugadores_faltantes") as tareas_pipelines_jugadores_faltantes:

		tarea_pipeline_jugadores_faltantes=PythonOperator(task_id="pipeline_jugadores_faltantes", python_callable=Pipeline_Jugadores_Faltantes, trigger_rule="none_failed_min_one_success")

		tarea_pipeline_jugadores_equipos_faltantes=PythonOperator(task_id="pipeline_jugadores_equipos_faltantes", python_callable=Pipeline_Jugadores_Equipos_Faltantes)

		tarea_pipeline_jugadores_seleccion_faltantes=PythonOperator(task_id="pipeline_jugadores_seleccion_faltantes", python_callable=Pipeline_Jugadores_Seleccion_Faltantes)


		# Si tu maquina no tiene buenos recursos es preferible ejecutar en serie en vez de en paralelo

		tarea_pipeline_jugadores_faltantes >> tarea_pipeline_jugadores_equipos_faltantes >> tarea_pipeline_jugadores_seleccion_faltantes
...
tareas_entorno >> tareas_pipelines_jugadores_faltantes >> tarea_data_lake_disponible >> [tareas_datalake, tarea_log_data_lake]
