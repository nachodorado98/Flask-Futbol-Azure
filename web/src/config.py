...
URL_DATALAKE_TITULOS=f"{URL_DATALAKE}/titulos/"
...
CARPETAS=[ESCUDOS, ENTRENADORES, PRESIDENTES, ESTADIOS, COMPETICIONES, PAISES, JUGADORES, SELECCIONES, USUARIOS, PERFIL, IMAGENES, TITULOS]