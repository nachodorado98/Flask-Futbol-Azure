...
from .blueprints.anadir_porra_partido import bp_anadir_porra_partido
from .blueprints.wrapped import bp_wrapped
...
def crear_app(configuracion:object)->Flask:
	...
	app.register_blueprint(bp_anadir_porra_partido)
	app.register_blueprint(bp_wrapped)
