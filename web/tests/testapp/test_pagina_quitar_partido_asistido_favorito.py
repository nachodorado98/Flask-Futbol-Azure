...
def test_pagina_quitar_partido_asistido_favorito_partido_no_existe(cliente, conexion_entorno, password_hash):
...
def test_pagina_quitar_partido_asistido_favorito_equipo_no_pertenece(cliente, conexion_entorno, password_hash):
...
def test_pagina_quitar_partido_asistido_favorito_partido_no_asistido(cliente, conexion_entorno, password_hash):
...
def test_pagina_quitar_partido_asistido_favorito_partido_no_favorito(cliente, conexion_entorno, password_hash):
...
def test_pagina_quitar_partido_asistido_favorito(cliente, conexion_entorno, password_hash):
