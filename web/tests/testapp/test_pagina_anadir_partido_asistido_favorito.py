...
def test_pagina_anadir_partido_asistido_favorito_partido_no_existe(cliente, conexion_entorno):
...
def test_pagina_anadir_partido_asistido_favorito_equipo_no_pertenece(cliente, conexion_entorno):
...
def test_pagina_anadir_partido_asistido_favorito_partido_no_asistido(cliente, conexion_entorno):
...
def test_pagina_anadir_partido_asistido_favorito(cliente, conexion_entorno):
...
def test_pagina_anadir_partido_asistido_favorito_partido_favorito_existe(cliente, conexion_entorno):
