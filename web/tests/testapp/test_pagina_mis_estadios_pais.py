...
def test_pagina_mis_estadios_pais_mapa_small(cliente, conexion_entorno):
	...
	with cliente as cliente_abierto:
		...
		assert "/estadios/mis_estadios_pais/mapa/mapa_small_mis_estadios_user_nacho98.html" in contenido
...
def test_pagina_mis_estadios_pais_mapa_small_usuarios(cliente, conexion_entorno, usuario):
	...
	with cliente as cliente_abierto:
		...
		respuesta.status_code==200
		assert "iframe" in contenido
		assert f"/estadios/mis_estadios_pais/mapa/mapa_small_mis_estadios_user_{usuario}.html" in contenido
...
def test_pagina_mis_estadios_pais_mapa_detalle(cliente, conexion_entorno):
	...
	with cliente as cliente_abierto:
		...
		respuesta.status_code==200
		assert "iframe" in contenido
		assert "/estadios/mis_estadios_pais/mapa/mapa_detalle_mis_estadios_user_nacho98.html" in contenido
...
def test_pagina_mis_estadios_pais_mapa_detalle_usuarios(cliente, conexion_entorno, usuario):
	...
	with cliente as cliente_abierto:
		...
		respuesta.status_code==200
		assert "iframe" in contenido
		assert f"/estadios/mis_estadios_pais/mapa/mapa_detalle_mis_estadios_user_{usuario}.html" in contenido
...
def test_pagina_mapa_mis_estadios_pais_mapa_small_existe(cliente, conexion_entorno):
	...
	with cliente as cliente_abierto:
		...
		respuesta=cliente_abierto.get("/estadios/mis_estadios_pais/mapa/mapa_small_mis_estadios_user_nacho98.html")
...
def test_pagina_mapa_mis_estadios_pais_mapa_detalle_existe(cliente, conexion_entorno):
	...
	with cliente as cliente_abierto:
		...
		respuesta=cliente_abierto.get("/estadios/mis_estadios_pais/mapa/mapa_detalle_mis_estadios_user_nacho98.html")
